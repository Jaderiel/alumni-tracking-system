...
<body> 
    <section id="menu">
        <div class="logo">
            <h4>LVCC Alumni <br> Tracking System</h4>
        </div>
        ...
        <div class="items">
            ...
            <li><i class="fa-solid fa-calendar-days"></i><a href="alumni-event.html">Events</a></li>
            <li><i class="fa-solid fa-briefcase"></i><a href="alumni-job.html">Jobs</a></li>
            <li><i class="fa-solid fa-image"></i><a href="alumni-gallery.html">Gallery</a></li>
